...
measures we report 5\% and 95\% inter-quartile ranges\edd{wut? that's not right}. \emph{Steady perf (s)}
...
chi-square; fj-kmeans; scala-stm-bench7; and scrabble. All of these benchmarks
reach a faster steady state on \graalce (than on \jnine) by 25--45$\%$.
